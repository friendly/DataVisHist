<div class="contents">
	...
	<div class="media">
		<div class="media-left">
			<img src="images/Michaelfriendly.jpg" width="110" alt="MF photo">
		</div>
		<div class="media-body">
			<h4 class="media-heading">Michael Friendly</h4>
			<p>Michael Friendly is a Professor of Psychology, founding chair of the 
			<a href="http://qm.info.yorku.ca/">Graduate Program in Quantitative
			Methods</a>, and an associate coordinator with the 
			<a href="http://www.yorku.ca/isr/scs/">Statistical Consulting Service</a> at
			York University. He earned a PhD in psychology from Princeton University,
			specializing in psychometrics and cognitive psychology.</p> 
			<p>His main research areas are the development of graphical methods for categorical
			and multivariate data and the history of data visualization. He is the author of
			five other books, most recently, <cite>Discrete Data Analysis with R:
			Visualization and Modeling Techniques for Categorical and Count Data</cite> (2015).
			</p>
			He is a
			fellow of the American Statistical Association, associate editor of the
			<em>Journal of Computational and Graphical Statistics</em> and
	...
	<div class="media">
		<div class="media-left">
			<img src="images/HowardWainer.jpg" width="110" alt="HW photo">
		</div>
		<div class="media-body">
			<h4 class="media-heading">Howard Wainer</h4>
			<p> 
			</p>
		</div>
	</div>
